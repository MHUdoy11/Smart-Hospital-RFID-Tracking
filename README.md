...
Processing: MATLAB algorithms filter the noise and calculate the person's coordinate (X, Y).
...
/Unity_Project: Contains the C# scripts for the VR visualization.
...
Integrating real-time hardware testing with commercial RFID readers.

Author: Hasan Md Mehedi | Master's Student,  Saga University
